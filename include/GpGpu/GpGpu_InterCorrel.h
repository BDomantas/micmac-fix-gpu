...
public:
  ...
  ///
  /// \brief signalComputeCorrel Signal le debut d'une corr�lation
  /// \param dZ
  ///
  ...
  ///
  /// \brief Data
  /// \return les donn�es de corr�lation
  ///
  SData2Correl& Data();
  ...
  /// \brief VolumeCost
  /// \param id
  /// \return Le volume de corr�lation
  ///
  float*        VolumeCost(ushort id);

  ///
  /// \brief TexturesAreLoaded
  /// \return Vraie si les images sont charg�es dans le device
  ///
  bool          TexturesAreLoaded();

  ///
  /// \brief SetTexturesAreLoaded D�finir si les images sont charg�es dans le device
  /// \param load
  ///
  void          SetTexturesAreLoaded(bool load);  

  ///
  /// \brief ReallocHostData R�allouer la m�moire dans l'hote
  /// \param interZ
  /// \param idBuff
  ///
  ...
  /// \return Un vecteur des cellules � corr�ler
  ///
