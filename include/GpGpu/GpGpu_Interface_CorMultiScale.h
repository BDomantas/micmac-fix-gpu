...
struct const_Param_Cor_MS
{
	...
	///
	/// \brief mDyRegGpu
	/// Indique si la r�gularisation est aussi calculer par gpugpu
	bool	mDyRegGpu;
	...
	///
	/// \brief init Initialidation des param�tres
	/// \param aVV
	/// \param aVPds
	/// \param offset0
	/// \param offset1
...
struct dataCorrelMS
{
	...
	/// \param dataImage Pointeur sur les donn�es des images dans l'hote
	/// \param id
	///
	...
	/// \param mImMasqErod_0 Pointeur source des donn�es du masque 0
	/// \param mImMasqErod_1 Pointeur source des donn�es du masque 1
	///
	...
	/// Synchronisation des donn�es entre hote et device
    void    syncDeviceData();


	///
	/// \brief dealloc
	/// D�sallocation de la m�moire hote et device
    void    dealloc();
...
/// Classe de gestion des processus pour le lancement de calcul GPGPU pour la corr�lation multiscale
...
public:
	...
	/// Lancer une correlation par pair en g�om�trie �pipolaire
	...
	///
	/// \brief init Initialisation des param�tres
	/// \param terrain
	/// \param aVV
	/// \param aVPds
	/// \param offset0
	...
	///
	/// \brief param
	/// \return Les param�tres de corr�lation
	///
