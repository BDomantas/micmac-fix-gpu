...
/// Structure de param�tres pour la programmation dynamique en CUDA
struct p_ReadLine
{
	///
	/// \brief ID_Bf_Icost
	///	Curseur de position dans le buffer des couts intrins�ques
    ushort          ID_Bf_Icost;
	///
	/// \brief line
	...
	///
	/// \brief Id_Buf
	/// Identifiant du buffer courrant en m�moire partag�e
    bool            Id_Buf;
	///
	/// \brief tid
	...
	///
	/// \brief prev_Dz
	/// Delta Z de la nappe de la position pr�c�dente
    short2          prev_Dz;
	///
	/// \brief prevDefCor
	/// Cout min de la cellule defCor pr�c�dente
    ushort          prevDefCor;
	///
	/// \brief pente
	...
	///
	/// \brief sizeBuffer
	/// Taille des buffers en m�moire partag�e
	...
	///
	/// \brief swBuf
	/// Changer de buffer en m�moire partag�e
	void swBuf()
    {
        Id_Buf = !Id_Buf;
    }
...
/// Structure de donn�es pour la r�gularisation en gpgpu
struct Data2Optimiz
{
public:
	...
	///
	/// \brief SetParamLine D�finir les param�tres de la ligne
	/// \param id
	/// \param pStr
	/// \param pIdStr
	/// \param lLine
	...
	///
	/// \brief ReallocIf R�allocation de la m�moire sous condition
	/// \param pStr
	/// \param pIdStr
	///
	...
	///
	/// \brief ReallocInputIf R�allocation de la m�moire sous condition
	/// \param pStr
	/// \param pIdStr
	///
	...
	///
	/// \brief ReallocOutputIf R�allocation de la m�moire sous condition
	/// \param pStr
	/// \param pIdStr
	/// \param idbuf
	///
	...
	///
	/// \brief SetNbLine D�finir le nombre de ligne
	/// \param nbl
	///
    void SetNbLine(uint nbl);

	///
	/// \brief CopyHostToDevice Copie des donn�es du host vers le device
	/// \param d2o
	/// \param idbuf
	///
	...
	///
	/// \brief CopyDevicetoHost Copie des donn�es du device vers le host
	/// \param d2o
	/// \param idbuf
	///
